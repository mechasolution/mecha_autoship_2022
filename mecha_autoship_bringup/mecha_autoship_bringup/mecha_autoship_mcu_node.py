        ...
        if packet_raw :
            ...
            try:
                ...
                # GPS
                    ...
                    latitude_d = float(str(packet_split[1])[0:2]) # 도
                    latitude_m = float(str(packet_split[1])[2:])  # 분
                    latitude = latitude_d + latitude_m / 60

                    longitude_d = float(str(packet_split[2])[0:3]) # 도
                    longitude_m = float(str(packet_split[2])[3:])  # 분
