...
def generate_launch_description():
    ...
    camera_pub_node_arg = DeclareLaunchArgument(
        "mecha_autoship_image_pub_params", default_value=mecha_autoship_image_pub_params
    )
    ...
    example_node = Node(
        namespace=NAMESPACE,
        package="mecha_autoship_total",
        executable="mecha_autoship_example_node",
        name="mecha_autoship_example_node",
        output="screen",
        parameters=[],
    )
